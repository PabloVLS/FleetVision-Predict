Nome do Projeto: FleetVision-Predict
Descrição para GitHub:
🚗 FleetVision-Predict - Sistema Inteligente de Previsão de Frota Veicular
...
# Acesse no navegador
http://localhost:8080
📊 Dados Base: Projeções baseadas em dados históricos oficiais da frota veicular brasileira (2006-2024)

Desenvolvido como projeto acadêmico para demonstração de modelos preditivos aplicados ao setor automotivo. 🎯
